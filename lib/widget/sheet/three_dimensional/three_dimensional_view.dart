...
import 'three_dimensional_logic.dart';

class ThreeDimensionalPage extends StatelessWidget {
  final String title;
  final List<Map<String, List<Map<String, List<String>>>>> data;
  final String? selected;
  final Function(String firstValue, String secondValue, String thirdValue)? resultData;
  ...
  Widget build(BuildContext context) {
    final logic = ThreeDimensionalLogic(title, data, selected, resultData);
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        if (state.firstData.isEmpty || state.secondData.isEmpty || state.thirdData.isEmpty) {
                          return;
                        }
                        Get.back();
                        if (state.resultData != null) {
                          state.resultData!(
                            ...
                            state.thirdData[state.thirdIndex],
                          );
                        }
                      },
                      child: Container(
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    flex: 2,
                    child: GetBuilder<ThreeDimensionalLogic>(
                        id: 'second',
                        builder: (_) {
                  ...
                  Expanded(
                    ...
                    child: GetBuilder<ThreeDimensionalLogic>(
                        ...
                        builder: (_) {
                          return _MyAreaPicker(
                            valueKey: ValueKey('third'),
                            controller: state.thirdController,
                            children: state.thirdData.map((data) {
                              return Align(
                                child: Text(
                                  data,
                                  overflow: TextOverflow.ellipsis,
                            ...
                            changed: (index) => logic.onChangeThird(index),
                          );
                        }),
                  ),
                ],
