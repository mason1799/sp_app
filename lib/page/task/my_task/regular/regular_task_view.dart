...
import 'regular_task_logic.dart';

class RegularTaskPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final logic = Get.put<RegularTaskLogic>(RegularTaskLogic());
    final state = Get.find<RegularTaskLogic>().state;
    return DebounceDetector(
      visibleQuery: logic.query,
      keyValue: 'RegularTaskLogic',
      child: GetBuilder<RegularTaskLogic>(
        builder: (_) {
