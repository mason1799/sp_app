...
class FixSelectMemberPage extends StatelessWidget {
  final logic = Get.find<FixSelectMemberLogic>();
  final state = Get.find<FixSelectMemberLogic>().state;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<FixSelectMemberLogic>(builder: (logic) {
                            ...
                            return Container(
                              ...
                              child: InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Checkbox(
                                      value: state.selectedList.indexWhere(
                                              (item) => item.selectedUserId == _childEntity.id && item.selectedGroupCode == _groupEntity.groupCode) >
                                          -1,
                              ...
                              children: [
                                Checkbox(
                                  value: state.selectedList
                                          .indexWhere((item) => item.selectedUserId == -1 && item.selectedGroupCode == _groupEntity.groupCode) >
                                      -1,
                                  onChanged: (value) => logic.toSelect(
                                    userId: -1,
                                    userName: '',
